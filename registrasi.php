...
if( isset($_POST["register"]) ) {
	if( registrasi($_POST) > 0 ) {
		echo "<script>
				alert('Send Successful!'); document.location.href = 'login.php';
			</script>";
	} else {
...
<section id="daftar" class="pt-36 pb-32">
    <div class="container">
        <div class="w-full px-4 lg:w-2/3 lg:mx-auto">
            <h1 class="block font-bold text-dark text-3xl lg:text-5xl">Register!</h1>
					...
					<div class="mb-3 form-group">
					    ...
					    <input type="text" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" name="username" id="username" autofocus placeholder="Username" required autocomplete="off">
					  </div>

					<div class="mb-3 form-group">
					    <label for="telp" class="text-base font-bold text-primary">No. Telp</label>
					    <input type="tel" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" id="telp" name="telp" placeholder="Telp"onkeypress="return hanyaAngka(event)" required autocomplete="off" pattern="(\+62|62|0)8[1-9][0-9]{6,13}$">
												<script>
					  ...
					  <div class="mb-3 form-group">
					    <label for="email" class="text-base font-bold text-primary">Email address</label>
					    <input type="email" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" id="email" name="email" placeholder="Email" required autocomplete="off">
					  </div>
					  <div class="mb-3 form-group">
					  ...
					  <div class="mb-3 form-group">
					    <label for="password2" class="text-base font-bold text-primary">Confirmation Password</label>
					    <input type="password" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" id="password2" name="password2" placeholder="Password" required autocomplete="off">
					  </div>

					  <!-- <button type="submit" name="register" class="btn btn-primary">Submit!</button> -->

					  <div class="w-full px-4 mt-5">
					<button class="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full w-full hover:opacity-80 hover:shadow-lg transition duration-500" type="submit" name="register">Register</button>
				</div>
					</form>
		</div>
	</div>
